...
void main() {
  test('FavoritesNotifier restaure les favoris sauvegardés au démarrage', () async {
  ...
  test('toggleFavorite sauvegarde les modifications dans SharedPreferences', () async {
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    ...
    // Act
    await container.read(favoritesNotifierProvider.notifier).toggleFavorite('prod_99');
